...
def main(config:ConfigParser):
    ...
    dataset_json = os.path.normpath(config['io']['dataset_json'])
    ...
    train_options = {
        ...
        'train_variables': SCENE_VARIABLES[0:3],  # Contains the relevant variables in the scenes.
